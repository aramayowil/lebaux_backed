...
export const sendWelcomeEmail = async (
  ...
  try {
    const verifyLink = `${FRONTEND_URL}/verify-account?email=${email}&vToken=${vToken}`
...
export const sendResetPasswordEmail = async (
  ...
  try {
    const resetLink = `${FRONTEND_URL}/reset-password?email=${email}&vToken=${vToken}`
                  ...
                  <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                      <td style="padding: 0 40px 40px 40px; text-align: center;">
                        ...
                        <p style="color: #999; font-size: 12px; margin-top: 40px; border-top: 1px solid #eeeeee; padding-top: 20px;">
...
//SERVICIO DE EMAILS CON RESEND MUCHO MEJOR PERO NECESEITA DOMINIO PROPIO
